...
import { faSearch, faUser, faArrowDown, faArrowUp, faSignOutAlt, faHome, faCalendar, faCloud } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <header className={styles.header}>
      ...
      <nav className={styles.nav}>
        ...
        <a href="#" className={styles.navItem}><FontAwesomeIcon icon={faCalendar} /> Calendar</a>
        <a href="#" className={styles.navItem}><FontAwesomeIcon icon={faCloud} /> Cloud</a>
      </nav>
